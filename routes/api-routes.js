    ...
    axios.get("https://www.theverge.com/tech").then(response => {
      ...
      $("div .c-entry-box--compact--article").each((i, element) => {
        ...
        if (
          $(element)
            .children("a")
            .children(".c-entry-box--compact__image")
            .children("noscript")
            .html() === null
        ) {
          article.imgSrc =
            "https://place-hold.it/450x300/666/fff/000?text=(Sorry,%20No%20Image)";
      ...
      Promise.all(newArticles).then(data => {
        res.json(data);
      });
    });
  });
